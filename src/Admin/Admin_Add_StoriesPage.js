...
//         try {
//             const response = await axios.post(`${config.API_BASE_URL}/api/admin/create_stories`, uploadData, {
...
//             <h2>Add Stories Page</h2>
//             <form onSubmit={handleSubmit} encType="multipart/form-data">
//                 <input type="text" name="storiesName" placeholder="Storie Name" value={formData.storiesName} onChange={handleChange} required />
//                 <input type="text" name="heading" placeholder="Heading" value={formData.heading} onChange={handleChange} required />
//                 <input type="text" name="subheading" placeholder="Sub heading" value={formData.subheading} onChange={handleChange} required />
//                 <input type="file" name="cardimg" onChange={handleFileChange} required />
//                 <textarea name="para1" placeholder="Paragraph 1" value={formData.para1} onChange={handleChange} required></textarea>
//                 <input type="file" name="img1" onChange={handleFileChange} required />
//                 <input type="file" name="img2" onChange={handleFileChange} required />
//                 <textarea name="para2" placeholder="Paragraph 2" value={formData.para2} onChange={handleChange} required></textarea>
//                 {formData.data.map((item, index) => (
//                     <div key={index}>
//                         <input type="text" name="title" placeholder="Data Title" value={item.title} onChange={(e) => handleChange(e, index)} required />
//                         <textarea name="para" placeholder="Data Paragraph" value={item.para} onChange={(e) => handleChange(e, index)} required></textarea>
//                     </div>
//                 ))}
//                 <button type="button" onClick={addDataField}>Add More Data</button>
                
                
//                 <input type="file" name="img3" onChange={handleFileChange} required />
//                 <input type="file" name="img4" onChange={handleFileChange} required />
//                 <input type="file" name="img5" onChange={handleFileChange} required />
